    ...
    <div className="space-y-6 text-sm">
      ...
      <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-4">
        ...
        <div className="flex items-start justify-between mb-4">
          ...
          <button className="px-3 py-1.5 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md border border-gray-300 dark:border-gray-600 text-xs">
            Upgrade
          </button>
        </div>
      ...
      {/* Bottom bar */}
      <div className="w-full px-4 py-3 text-center bg-gray-100 dark:bg-gray-800 rounded-lg text-gray-700 dark:text-gray-300 text-xs cursor-pointer">
        Manage Billing
      </div>
    </div>
  );
